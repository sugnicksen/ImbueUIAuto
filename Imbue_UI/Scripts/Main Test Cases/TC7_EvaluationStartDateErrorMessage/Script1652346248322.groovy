...
String evaluationName = 'Test Katalon Evaluation'
...
WebUI.setText(findTestObject('Object Repository/Imbue_AddEvaluation/Page_CR App/input_Evaluation Title_title'), evaluationName)
